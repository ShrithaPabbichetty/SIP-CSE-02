...
def simulateMultiDeviceResponse (devices, response_length, communication_times):
    ...
    while totalGenerated < response_length:
        ...
        roundLatency = delay + device.draft_token_time * tokensAttempted
...
def main(): 
    device = EdgeDevice(device_id="device_1", draft_token_time=0.5, accuracyprediction=0.8, numberOftokensGenerated=10)

    device2 = EdgeDevice(device_id="device-2", draft_token_time=0.8, accuracyprediction=0.9, numberOftokensGenerated=4)
    device3 = EdgeDevice(device_id="device-3", draft_token_time=0.2, accuracyprediction=0.7, numberOftokensGenerated=3)
    device4 = EdgeDevice(device_id="device-4", draft_token_time=0.3, accuracyprediction=0.85, numberOftokensGenerated=3)
    communication_times = [0.1, 0.2, 0.3]
